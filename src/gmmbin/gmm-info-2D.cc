...
int main(int argc, char *argv[]) {
  try {
    ...
    std::cout << "number of transition-ids-TopDown " 
		      << trans_model.NumTransitionIds_TopDown() << '\n';
	std::cout << "number of transition-ids-LeftRight " 
		      << trans_model.NumTransitionIds_LeftRight() << '\n';
